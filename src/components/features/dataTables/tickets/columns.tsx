...
export const useTicketsColumns = (data: MutatedTickets[] | undefined) => {
  const [ticketsColumns, setTicketsColumns] = useState<ColumnDef<MutatedTickets>[]>([]);
